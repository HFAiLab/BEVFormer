...
class LoadMultiViewImageFromFilesHF(object):
...
class FFrecordClient(BaseStorageBackend):
    ...
    def __init__(self, fname, check_data=False):
        ...
        with open(filename2idx_file, 'rb') as handle:
            self.filename2idx_file = pickle.load(handle)
